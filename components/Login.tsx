          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              ...
              <div className="relative">
                <i className="fas fa-user-shield absolute left-4 top-1/2 -translate-y-1/2 text-slate-600 text-xs"></i>
                <input
                  type="text"
                  value={username}
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <i className="fas fa-keypad absolute left-4 top-1/2 -translate-y-1/2 text-slate-600 text-xs"></i>
                <input
                  type="password"
                  value={pin}
                  onChange={(e) => setPin(e.target.value)}
                  className="w-full bg-slate-950/50 border border-white/5 rounded-2xl pl-11 pr-4 py-3.5 text-sm text-white focus:border-cyan-500 outline-none transition-all placeholder:text-slate-700 shadow-inner tracking-[1em]"
                  placeholder="••••"
                  required
                />
              </div>
            ...
            {error && (
              <p className="text-[10px] font-black text-red-400 uppercase tracking-tight text-center bg-red-500/5 py-3 rounded-xl border border-red-500/10">
                {error}
              </p>
            )}
